...
// Dummy reviews array
const allReviews = [
  { text: "Emelie sang our first dance song at our wedding and made a special moment even more beautiful.", author: "Henri & Rebecca, Oxford", rating: 5 },
  { text: "Professional and reliable. A pleasure to work with.", author: "John, Reading", rating: 5 },
  { text: "Highly recommend Emelie, a beautiful voice and a joy to have at our event.", author: "Lisa, Guildford", rating: 5 },
  { text: "Stunning vocals and heartfelt performance!", author: "Paul, Brighton", rating: 5 },
  { text: "Absolutely magical!", author: "Gemma, Winchester", rating: 5 },
  { text: "Top-tier talent. Our guests were blown away.", author: "Ellie, London", rating: 5 },
  { text: "Punctual, prepared and totally professional.", author: "Matt, Surrey", rating: 5 },
];
      ...
      <div className="relative w-full h-[60vh] text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full">
          ...
          <div className="flex gap-6">
            <a href="https://www.instagram.com/emeliehallett/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:text-pink-300 transition-colors">
              <FaInstagram size={28} />
            </a>
            <a href="https://www.tiktok.com/@emeliehallettmusic" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="hover:text-pink-300 transition-colors">
              <FaTiktok size={28} />
            </a>
          </div>
        </div>
